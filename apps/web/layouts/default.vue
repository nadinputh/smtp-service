<template>
  <div class="flex h-screen bg-gray-50 dark:bg-gray-900">
    ...
    >
      ...
      <!-- User profile footer -->
      <div
        ref="profileMenuWrapperRef"
        class="border-t border-gray-200 dark:border-gray-700 relative"
      >
        <!-- Profile popover -->
        <Transition
            ...
            >
              <div class="flex items-start justify-between gap-2">
                ...
                <NuxtLink
                  ...
                  aria-label="Settings"
                  class="p-1 -m-1 text-gray-500 dark:text-gray-400 hover:text-gray-600 dark:hover:text-gray-300 transition-colors shrink-0 mt-0.5"
                  title="Settings"
                >
        ...
        >
          ...
          >
            ...
            <button
              ...
              class="shrink-0 p-1.5 -m-1.5 text-gray-500 dark:text-gray-400 hover:text-gray-600 dark:hover:text-gray-300 transition-colors"
            >
...
// Close the profile popover on outside click, and Escape closes
// whichever overlay (popover or create-inbox modal) is open.
function handleDocumentClick(e: MouseEvent) {
  if (
    showProfileMenu.value &&
    profileMenuWrapperRef.value &&
    !profileMenuWrapperRef.value.contains(e.target as Node)
  ) {
    showProfileMenu.value = false;
  }
}
